...
// ─── VALIDATION STUB (validator-aware) ────────────────────────────────────────
...
`;
        ...
        default:
            return `// TODO: Add auth validation schema for your chosen validator

export const AuthValidation = {
  loginSchema: null as any,
  registerSchema: null as any,
};
`;
    }
}
...
//
// NOTE: Hash passwords in auth.service.ts before calling db.insert()
`;
